...
def encoding_function():
    ...
    messagebox.showinfo("Encoded message", "Success! Here is your encoded message. Be sure to copy it:\n" + returnmes)
    en.delete(0, 'end')
...
def decoding_function():
    ...
    messagebox.showinfo("Decoded message", "Success! Here is your decoded message. Be sure to copy it:\n" + returnmes)
    en.delete(0, 'end')
...
en = Entry(root, width = 30, font=('Helvatical bold',20))
en.grid(row = 1, column = 0, columnspan = 2, padx = 10, pady = 10)
